| file name | luminaire test method | symmetry        | max h angle | equal interval | test lab | include electrical data | Photometric Toolbox lumen | lumen(cubic spline) | lumen(linear) |
| --------- | --------------------- | --------------- | ----------- | -------------- | -------- | ----------------------- | ------------------------- | ------------------- | ------------- |
